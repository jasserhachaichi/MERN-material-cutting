...
var KTApp = (function() {
    ...
    n = function(e, t) {
      if ("1" !== e.getAttribute("data-kt-initialized")) {
        ...
        e.hasAttribute("data-bs-delay-hide") &&
          ...
          (t.delay = n), e.hasAttribute("data-bs-dismiss") &&
        ...
        [].slice
          ...
          .map(function(e) {
            if (KTUtil.isInViewport(e) && KTUtil.visible(e)) {
              ...
              (n = parseFloat(n.replace(/,/g, ""))), e.hasAttribute(
                ...
                )), new countUp.CountUp(e, n, t).start(), e.classList.add(
                "counted"
  ...
  return {
          ...
          e.map(function(e) {
            if ("1" !== e.getAttribute("data-kt-initialized")) {
              ...
              "today" === e.getAttribute("data-kt-daterangepicker-range") &&
                ((t = moment()), (n = moment())), $(e).daterangepicker(
                {
                  startDate: t,
                  endDate: n,
                  opens: r,
                ...
                o
              ), o(t, n), e.setAttribute("data-kt-initialized", "1");
            }
          });
        }
      })(), [].slice
    ...
    showPageLoading: function() {
      document.body.classList.add("page-loading"), document.body.setAttribute(
    ...
    var i = {
      ...
      r = function() {
        (n.options = KTUtil.deepExtend(
          ...
          i,
          t
        )), (n.element = e), (n.overlayElement = null), (n.blocked = !1), (n.positionChanged = !1), (n.overflowChanged = !1), KTUtil.data(
          n.element
        ).set("blockui", n);
      };
        ...
        if (!1 !== KTEventHandler.trigger(n.element, "kt.blockui.block", n)) {
          ...
          n.options.zIndex > 0
            ...
            : "auto" != KTUtil.css(n.element, "z-index") &&
              (r = KTUtil.css(n.element, "z-index")), n.element.classList.add(
            "blockui"
            ...
            (
              ...
              (n.overflowChanged = !0)
            ), (n.overlayElement = document.createElement(
            "DIV"
          )), n.overlayElement.setAttribute(
            "class",
            "blockui-overlay " + n.options.overlayClass
          ), (n.overlayElement.innerHTML = n.options.message), KTUtil.css(
            n.overlayElement,
            "z-index",
            r
          ), n.element.append(
            n.overlayElement
          ), (n.blocked = !0), KTEventHandler.trigger(
            n.element,
...
var KTCookie = {
  ...
  set: function(e, t, n) {
    null == n && (n = {}), (n = Object.assign({}, { path: "/" }, n))
    ...
    var i = {
      ...
      r = function() {
        (n.options = KTUtil.deepExtend(
          ...
          i,
          t
        )), (n.element = e), (n.incElement = n.element.querySelector(
          '[data-kt-dialer-control="increase"]'
        )), (n.decElement = n.element.querySelector(
          '[data-kt-dialer-control="decrease"]'
        )), (n.inputElement = n.element.querySelector(
          "input[type]"
        )), "true" === c("currency") && (n.options.currency = !0), c(
          "decimals"
        ) && (n.options.decimals = parseInt(c("decimals"))), c("prefix") &&
          (n.options.prefix = c("prefix")), c("suffix") &&
          (n.options.suffix = c("suffix")), c("step") &&
          (n.options.step = parseFloat(c("step"))), c("min") &&
          (n.options.min = parseFloat(c("min"))), c("max") &&
          (n.options.max = parseFloat(c("max"))), (n.value = parseFloat(
      ...
      a = function() {
        return KTEventHandler.trigger(
          ...
          n.value + n.options.step), s(), KTEventHandler.trigger(
          n.element,
          "kt.dialer.increased",
          n
        ), n;
      ...
      s = function(e) {
        KTEventHandler.trigger(n.element, "kt.dialer.change", n), (n.value =
          void 0 !== e ? e : u(n.inputElement.value)), null !== n.options.min &&
          n.value < n.options.min &&
          (n.value = n.options.min), null !== n.options.max &&
          n.value > n.options.max &&
          (n.value = n.options.max), (n.inputElement.value = d(
          n.value
        )), n.inputElement.dispatchEvent(
          new Event("change")
      ...
      u = function(e) {
        return (e = e
          ...
          .replace(/(\..*)\./g, "$1")
          .replace(/(?!^)-/g, "")
          .replace(/^0+(\d)/gm, "$1")), (e = parseFloat(e)), isNaN(e) &&
          (e = 0), e;
      },
      d = function(e) {
        return (e = parseFloat(e).toFixed(n.options.decimals)), n.options
          .currency &&
          (e = e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")), n.options
          .prefix +
          e +
          n.options.suffix;
      },
      ...
      var i = {
        ...
        r = function() {
          (n.options = KTUtil.deepExtend(
            ...
            "drawer"
          )), (n.element = e), (n.overlayElement = null), (n.name = n.element.getAttribute(
            "data-kt-drawer-name"
          )), (n.shown = !1), n.lastWidth, n.lastHeight, (n.toggleElement = null), n.element.setAttribute(
            "data-kt-drawer",
            "true"
          ), o(), u(), KTUtil.data(n.element).set("drawer", n);
        },
        o = function() {
          var e = m("toggle"),
            t = m("close");
...
(KTDrawer.getInstance = function(e) {
  ...
  KTDrawer.createInstances(), !1 === KTDrawerHandlersInitialized &&
    (
...
var KTEventHandler = (function() {
  var e = {},
    t = function(t, n, i, r) {
      ...
      return a || (a = []), a.push(o), KTUtil.data(t).set(n, a), e[n] ||
        (e[n] = {}), (e[n][o] = { name: n, callback: i, one: r, fired: !1 }), o;
    };
  return {
    ...
    off: function(t, n, i) {
      return (function(t, n, i) {
        var r = KTUtil.data(t).get(n),
          o = r && r.indexOf(i);
        -1 !== o && (r.splice(o, 1), KTUtil.data(t).set(n, r)), e[n] &&
          e[n][i] &&
          delete e[n][i];
      })(t, n, i);
    },
...
var KTFeedback = function(e) {
  var t = this,
    ...
    i = function() {
      (t.options = KTUtil.deepExtend({}, n, e)), (t.uid = KTUtil.getUniqueId(
        "feedback"
      )), t.element, (t.shown = !1), r(), KTUtil.data(t.element).set(
        "feedback",
        t
      );
    },
    ...
    o = function() {
      (t.element = document.createElement("DIV")), KTUtil.addClass(
        t.element,
        "feedback feedback-popup"
      ), KTUtil.setHTML(t.element, t.options.content), "top-center" ==
        t.options.placement && a(), document.body.appendChild(
        t.element
    ...
    a = function() {
      ...
      KTUtil.addClass(t.element, "feedback-top-center"), KTUtil.css(
        t.element,
        "width",
        e
      ), KTUtil.css(t.element, "left", "50%"), KTUtil.css(
        t.element,
        "top",
        "-" + n
      );
  ...
  i(), (t.show = function() {
    return (function() {
      if (!1 !== KTEventHandler.trigger(t.element, "kt.feedback.show", t))
        return "popup" === t.options.type && o(), KTEventHandler.trigger(
          t.element,
          "kt.feedback.shown",
          t
        ), t;
    ...
    return (function() {
      if (!1 !== KTEventHandler.trigger(t.element, "kt.feedback.hide", t))
        return "popup" === t.options.type &&
          l(), (t.shown = !1), KTEventHandler.trigger(
          t.element,
          "kt.feedback.hidden",
          t
        ), t;
    ...
    var i = {},
      r = function() {
        (n.options = KTUtil.deepExtend({}, i, t)), (n.uid = KTUtil.getUniqueId(
          "image-input"
        )), (n.element = e), (n.inputElement = KTUtil.find(
          e,
          'input[type="file"]'
      ...
      a = function(e) {
        if (
          ...
          }), t.readAsDataURL(n.inputElement.files[0]), n.element.classList.add(
            "image-input-changed"
      ...
      var i = {
        ...
        r = function() {
          (n.options = KTUtil.deepExtend(
            ...
            "menu"
          )), (n.element = e), n.triggerElement, (n.disabled = !1), n.element.setAttribute(
            "data-kt-menu",
            "true"
          ), d(), u(), KTUtil.data(n.element).set("menu", n);
        },
        o = function(e) {
        ...
        y = function(e) {
          if (
            ...
            null !== a && a >= o && (o = a + 1), o > 0 &&
              ...
              KTUtil.css(t, "height", r), KTUtil.css(
              t,
              "display",
              ""
            ), KTUtil.css(t, "overflow", ""), U(e, t), KTUtil.addClass(
              e,
              "show"
            ), KTUtil.addClass(e, "menu-dropdown"), KTUtil.addClass(
              t,
              "show"
            ), !0 === L(e, "overflow")
              ? (
        ...
        w = function(e) {
          if (
            ...
            var t = g(e);
            KTUtil.css(t, "z-index", ""), KTUtil.css(
              t,
              "width",
              ""
            ), KTUtil.css(t, "height", ""), KTUtil.removeClass(
              e,
              "show"
            ), KTUtil.removeClass(e, "menu-dropdown"), KTUtil.removeClass(
              t,
              "show"
            ), !0 === L(e, "overflow") &&
              (
        ...
        A = function(e) {
          if (
            ...
            !0 === L(e, "expand")
              ...
              : !1 === L(e, "expand")
                ? (i = !1)
                : !0 === L(n.element, "expand") && (i = !0), !1 === i &&
              I(e), !0 === KTUtil.data(e).has("popper") &&
              w(e), KTUtil.addClass(e, "hover"), KTUtil.addClass(
              e,
              "showing"
              ...
              KTUtil.removeClass(
                e,
                "showing"
              ), KTUtil.addClass(e, "show"), KTUtil.addClass(t, "show"), KTEventHandler.trigger(n.element, "kt.menu.accordion.shown", e);
            });
          }
        },
        x = function(e) {
          if (
            ...
            var t = g(e);
            KTUtil.addClass(e, "hiding"), KTUtil.slideUp(
              t,
              n.options.accordion.slideSpeed,
              function() {
                KTUtil.removeClass(e, "hiding"), KTUtil.removeClass(
                  e,
                  "show"
                ), KTUtil.removeClass(t, "show"), KTUtil.removeClass(
                  e,
                  "hover"
...
(KTMenu.getInstance = function(e) {
  ...
  KTMenu.createInstances(), !1 === KTMenuHandlersInitialized &&
    ...
    var i = {
      ...
      r = function() {
        (n.options = KTUtil.deepExtend(
          ...
          i,
          t
        )), (n.score = 0), (n.checkSteps = 5), (n.element = e), (n.inputElement = n.element.querySelector(
          "input[type]"
      ...
      a = function() {
        var e = 0,
          t = m();
        !0 === l() && (e += t), !0 === n.options.checkUppercase &&
          !0 === s() &&
          (e += t), !0 === n.options.checkLowercase &&
          !0 === u() &&
          (e += t), !0 === n.options.checkDigit &&
          !0 === d() &&
          (e += t), !0 === n.options.checkChar &&
          !0 === c() &&
          (e += t), (n.score = e), f();
      },
      l = function() {
      ...
      p = function() {
        ...
        "password" === n.inputElement.getAttribute("type").toLowerCase()
          ...
          : n.inputElement.setAttribute("type", "password"), e.classList.add(
          "d-none"
        ), t.classList.remove("d-none"), n.inputElement.focus();
      },
      g = function() {
        return n.score;
      };
      ...
      var i = { saveState: !0 },
        r = function() {
          (n.options = KTUtil.deepExtend(
            ...
            i,
            t
          )), (n.element = e), (n.id = n.element.getAttribute(
            "id"
          )), n.element.setAttribute(
            "data-kt-scroll",
            "true"
          ), l(), KTUtil.data(n.element).set("scroll", n);
        },
        o = function(e) {
        ...
        d = function() {
          ...
          if (
            null !== r &&
            ((e = document.querySelectorAll(r)) && e.length > 0)
          )
            for (a = 0, l = e.length; a < l; a++)
              !1 !== KTUtil.visible(e[a]) && (t -= m(e[a]));
          return null !== o &&
            "object" != typeof o &&
            (t -= parseInt(o)), String(t) + "px";
        },
        c = function(e) {
          var t = 0;
          return null !== e &&
        ...
        p = function() {
          return f("height")
            ...
            : f("min-height")
              ? "min-height"
              : f("max-height") ? "max-height" : void 0;
        };
...
(KTScroll.getInstance = function(e) {
  ...
  KTScroll.createInstances(), !1 === KTScrollHandlersInitialized &&
  ...
  if (null != e) {
    var i = { offset: 300, speed: 600 },
      r = function() {
        (n.options = KTUtil.deepExtend({}, i, t)), (n.uid = KTUtil.getUniqueId(
          "scrolltop"
        )), (n.element = e), n.element.setAttribute(
          "data-kt-scrolltop",
          "true"
        ), o(), KTUtil.data(n.element).set("scrolltop", n);
      },
      o = function() {
    ...
    var i = {
      ...
      r = function() {
        (n.options = KTUtil.deepExtend(
          ...
          i,
          t
        )), (n.processing = !1), (n.element = e), (n.contentElement = v(
          "content"
        )), (n.formElement = v("form")), (n.inputElement = v(
          "input"
        )), (n.spinnerElement = v("spinner")), (n.clearElement = v(
          "clear"
        )), (n.toggleElement = v("toggle")), (n.submitElement = v(
          "submit"
        )), (n.toolbarElement = v("toolbar")), (n.minLength = parseInt(
          g("min-length")
        )), (n.resultsElement = v("results")), (n.suggestionElement = v(
          "suggestion"
        )), (n.emptyElement = v("empty")), n.element.setAttribute(
          "data-kt-search",
          "true"
        ), (n.layout = g("layout")), "menu" === n.layout
          ? (n.menuObject = new KTMenu(n.contentElement))
          : (n.menuObject = null), m(), o(), KTUtil.data(n.element).set(
          "search",
          n
        );
      },
      o = function() {
        n.inputElement.addEventListener(
          "focus",
          a
  ...
  if (null != e) {
    var i = {
      ...
      r = function() {
        (n.options = KTUtil.deepExtend({}, i, t)), (n.uid = KTUtil.getUniqueId(
          ...
          n.steps.length), (n.passedStepIndex = 0), (n.currentStepIndex = 1), (n.clickedStepIndex = 0), n
          .options.startIndex > 1 &&
          o(n.options.startIndex), (n.nextListener = function(e) {
          e.preventDefault(), KTEventHandler.trigger(
            n.element,
            "kt.stepper.next",
            n
          );
            ...
            for (var t = 0, i = n.steps.length; t < i; t++)
              if (n.steps[t] === this)
                return (n.clickedStepIndex =
                  t + 1), void KTEventHandler.trigger(
                  n.element,
                  "kt.stepper.click",
                  n
                );
      ...
      o = function(e) {
        if (
          ...
          return (e = parseInt(e)), (n.passedStepIndex =
            n.currentStepIndex), (n.currentStepIndex = e), a(), KTEventHandler.trigger(
            n.element,
            "kt.stepper.changed",
            n
          ), n;
      ...
      a = function() {
        ...
        (e = l() ? "last" : s() ? "first" : "between"), KTUtil.removeClass(
          n.element,
          "last"
        ), KTUtil.removeClass(n.element, "first"), KTUtil.removeClass(
          n.element,
          "between"
    ...
    !0 === KTUtil.data(e).has("stepper")
      ...
      return KTUtil.removeEvent(
        ...
        "click",
        n.previousListener
      ), KTUtil.off(n.element, "click", n.stepListenerId), void KTUtil.data(
        n.element
      ).remove("stepper");
    }), (n.on = function(e, t) {
      return KTEventHandler.on(n.element, e, t);
  ...
  KTSticky = function(e, t) {
    ...
    if (null != e) {
      var i = {
        ...
        r = function() {
          (n.element = e), (n.options = KTUtil.deepExtend(
            ...
            "data-kt-sticky-" + n.name), (n.attributeName2 =
            "data-kt-" +
            n.name), (n.eventTriggerState = !0), (n.lastScrollTop = 0), n.scrollHandler, n.element.setAttribute(
            "data-kt-sticky",
            "true"
          ), window.addEventListener("scroll", o), o(), KTUtil.data(
            n.element
          ).set("sticky", n);
        },
        o = function(e) {
          ...
          if (!1 !== i) {
            (i = parseInt(i)), (r = r
              ...
              : null), (t = KTUtil.getScrollTop()), document.documentElement
              .scrollHeight -
              window.innerHeight -
              KTUtil.getScrollTop();
        ...
        l = function() {
          KTUtil.css(n.element, "top", ""), KTUtil.css(
            n.element,
            "width",
            ""
          ), KTUtil.css(n.element, "left", ""), KTUtil.css(
            n.element,
            "right",
            ""
          ), KTUtil.css(n.element, "z-index", ""), KTUtil.css(
            n.element,
            "position",
            ""
          );
        ...
        s = function() {
          ...
          return (t += parseFloat(
            KTUtil.css(n.element, "margin-top")
          )), (t += parseFloat(
            KTUtil.css(n.element, "margin-bottom")
          )), KTUtil.css(e, "border-top") &&
            (t += parseFloat(KTUtil.css(n.element, "border-top"))), KTUtil.css(
            e,
            "border-bottom"
          ) && (t += parseFloat(KTUtil.css(n.element, "border-bottom"))), t;
        },
        u = function(e) {
      ...
      !0 === KTUtil.data(e).has("sticky")
        ...
        return window.removeEventListener("scroll", o), void KTUtil.data(
          n.element
        ).remove("sticky");
      }), (n.on = function(e, t) {
        return KTEventHandler.on(n.element, e, t);
...
(KTSticky.getInstance = function(e) {
  ...
  KTSticky.createInstances(), !1 === KTStickyHandlersInitialized &&
...
(KTSwapper.getInstance = function(e) {
  ...
  KTSwapper.createInstances(), !1 === KTSwapperHandlersInitialized &&
  ...
  if (e) {
    var i = { saveState: !0 },
      r = function() {
        (n.options = KTUtil.deepExtend({}, i, t)), (n.uid = KTUtil.getUniqueId(
          "toggle"
        )), (n.element = e), (n.target = document.querySelector(
          n.element.getAttribute("data-kt-toggle-target")
        )
          ? document.querySelector(
              n.element.getAttribute("data-kt-toggle-target")
            )
          : n.element), (n.state = n.element.hasAttribute(
      ...
      a = function() {
        return KTEventHandler.trigger(n.element, "kt.toggle.change", n), u()
          ? s()
          : l(), KTEventHandler.trigger(n.element, "kt.toggle.changed", n), n;
      },
      l = function() {
        if (!0 !== u())
          return KTEventHandler.trigger(
            ...
            "kt.toggle.enable",
            n
          ), n.target.setAttribute(n.attribute, "on"), n.state.length > 0 &&
            n.element.classList.add(n.state), void 0 !== KTCookie &&
            !0 === n.options.saveState &&
            KTCookie.set(n.attribute, "on"), KTEventHandler.trigger(
            n.element,
            "kt.toggle.enabled",
            n
          ), n;
      ...
      s = function() {
        if (!1 !== u())
          return KTEventHandler.trigger(
            ...
            "kt.toggle.disable",
            n
          ), n.target.removeAttribute(n.attribute), n.state.length > 0 &&
            n.element.classList.remove(n.state), void 0 !== KTCookie &&
            !0 === n.options.saveState &&
            KTCookie.remove(n.attribute), KTEventHandler.trigger(
            n.element,
            "kt.toggle.disabled",
            n
          ), n;
  ...
  return {
    ...
    triggerEvent: function(e, t) {
      ...
      if (e.dispatchEvent) {
        ...
        var r = "change" != t;
        (o = n.createEvent(i)).initEvent(
          t,
          r,
          !0
        ), (o.synthetic = !0), e.dispatchEvent(o, !0);
      } else if (e.fireEvent) {
        var o;
      ...
      if (e)
        if (void 0 !== n)
          ...
          if (r && r.getComputedStyle)
            return (t = t
              .replace(/([A-Z])/g, "-$1")
              .toLowerCase()), r.getComputedStyle(e, null).getPropertyValue(t);
          if (e.currentStyle)
            return (t = t.replace(/\-(\w)/g, function(e, t) {
              ...
              ? (function(t) {
                  ...
                  return (e.runtimeStyle.left =
                    e.currentStyle.left), (e.style.left = t || 0), (t =
                    e.style.pixelLeft +
    ...
    slide: function(e, t, n, i, r) {
      if (
        ...
        KTUtil.css(e, "padding-top") &&
          ...
          (a = parseInt(KTUtil.data(e).get("slide-padding-top"))), KTUtil.data(
          e
        ).has("slide-padding-bottom") &&
          (l = parseInt(KTUtil.data(e).get("slide-padding-bottom"))), "up" == t
          ? (
          ...
          : "down" == t &&
            (
              ...
              KTUtil.animate(
                ...
                function() {
                  (e.style.height = ""), (e.style.display =
                    ""), (e.style.overflow = ""), "function" == typeof i && i();
                }
              )
            );
      }
    ...
    scrollTo: function(e, t, n) {
      ...
      t && (o -= t), (i =
        ...
        0), (r = o), KTUtil.animate(i, r, n, function(e) {
    ...
    colorLighten: function(e, t) {
      const n = function(e, t) {
        let n = parseInt(e, 16) + t,
          i = n > 255 ? 255 : n;
        return (i =
          i.toString(16).length > 1 ? i.toString(16) : `0${i.toString(16)}`), i;
      };
      return (e =
        e.indexOf("#") >= 0 ? e.substring(1, e.length) : e), (t = parseInt(
        255 * t / 100
      ...
      if ("object" == typeof (e = KTUtil.parseJson(e))) {
        ...
        for (var l in e)
          (o =
            "default" === l
              ? 0
              : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <=
            n &&
            o > a &&
            ((r = l), (a = o));
        i = r ? e[r] : e;
    ...
    getSelectorMatchValue: function(e) {
      ...
      if ("object" == typeof (e = KTUtil.parseJson(e))) {
        if (void 0 !== e.match) {
          ...
          (e = Object.values(e.match)[0]), null !== document.querySelector(n) &&
            (t = e);
        }
      } else t = e;
      return t;
    ...
    getConditionalValue: function(e) {
      ...
      return null !== t &&
        void 0 !== t.match &&
        (t = KTUtil.getSelectorMatchValue(t)), null === t &&
        null !== e &&
        void 0 !== e.default &&
        (t = e.default), t;
    },
              ...
              $.ajax({
                ...
                success: function(e, t, n) {
                  history.scrollRestoration &&
                    (history.scrollRestoration = "manual"), location.reload();
                },
                error: function(e) {
                  toastr.error(
  ...
  var e,
    ...
    m = function(e) {
      setTimeout(function() {
        ...
        t.classList.add(
          "d-none"
        ), 3 === i ? (n.classList.add("d-none"), r.classList.remove("d-none")) : (n.classList.remove("d-none"), r.classList.add("d-none")), e.complete();
      }, 1500);
    },
    f = function(e) {
      t.classList.remove("d-none"), n.classList.add("d-none"), r.classList.add(
        "d-none"
      );
    };
  return {
...
var KTThemeMode = (function() {
  var e,
    ...
    i = function(i, r) {
      ...
      }, 300), localStorage.setItem("data-bs-theme", i), s &&
        (localStorage.setItem("data-bs-theme-mode", r), a(s)), i !== l &&
        KTEventHandler.trigger(
    ...
    a = function(t) {
      ...
      i && i.classList.remove("active"), t.classList.add(
        "active"
      ), localStorage.setItem("data-bs-theme-mode", n);
    };
  return {
    init: function() {
      (e = document.querySelector('[data-kt-element="theme-mode-menu"]')), i(
        n(),
        r()
      ), KTEventHandler.trigger(
        document.documentElement,
...
var KTAppAside = (function() {
  ...
  return {
    init: function() {
      var n;
      (
        (e = document.querySelector("#kt_aside")),
        (t = document.querySelector("#kt_aside_menu_wrapper")),
        null !== e
      ) &&
        (t &&
