        ...
        const fetchMaterials = async () => {
            try {
                ...
                if (materials.length > 0) {
                    ...
                    setFormData(prevFormData => ({ ...prevFormData, material: firstMaterial }));
                }
            } catch (error) {
                                ...
                                <div className="card card-flush py-4">
                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className='mb-2 fv-row'>
                                            ...
                                            <div className="mb-2">
                                                <textarea className="form-control" placeholder="Description" name="materialTypedescription" id="floatingTextarea2" style={{ height: "100px", borderRadius: "15px" }} onChange={handleInputChange} ></textarea>
                                            </div>
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <select className="form-select mb-2"
                                                ...
                                                {MotherMaterialList.map((singleMotherMaterial, index) => (
                                                    <option key={index} value={singleMotherMaterial.MotherMaterial}>
