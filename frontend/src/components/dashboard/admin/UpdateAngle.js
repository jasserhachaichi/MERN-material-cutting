                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <input type="text" name="angle_name" className="form-control mb-2"
                                                placeholder="Angle name" defaultValue={formData.angle_name} onChange={handleInputChange} required/>
                                        ...
                                        <div className='mb-2 fv-row'>
                                            ...
                                            <div className="mb-2">
                                                <textarea className="form-control" defaultValue={formData.angledescription} placeholder="Description" name="angledescription" id="floatingTextarea2" style={{ height: "100px", borderRadius: "15px" }} onChange={handleInputChange} ></textarea>
                                            </div>
