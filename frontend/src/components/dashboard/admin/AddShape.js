...
function AddShape() {
    ...
    const handleSubmit = async (e) => {
        ...
        const requiredFields = ['avatarShape', 'avatarEdge', 'shape_name', 'price','avatarAngles', "NB_Angle"];
                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <input type="text" name="shape_name" className="form-control mb-2"
                                                placeholder="Shape name" defaultValue={formData.shape_name} onChange={handleInputChange}  />
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <div className="mb-2">
                                                <textarea className="form-control" placeholder="Description" name="shapedescription" id="floatingTextarea2" style={{ height: "100px", borderRadius: "15px" }}  onChange={handleInputChange} ></textarea>
                                            </div>
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <input type="number" min={0}  name="NB_Angle" className="form-control mb-2"
                                                placeholder="Number of angles" defaultValue={formData.NB_Angle} onChange={handleInputChange}  />
                                        ...
                                        <div className="card-body pt-0">
                                            ...
                                            <div className="d-flex flex-wrap gap-5">
                                                ...
                                                <div className="fv-row w-100 flex-md-root">
                                                    ...
                                                    <input type="number"  min={0} max={100}  className="form-control mb-2" name='vat_amount'  defaultValue={formData.vat_amount}   onChange={handleInputChange} />
