...
function UpdateMaterial() {
    ...
    useEffect(() => {
        ...
        setImagePreviews(prev => ({
            ...prev,
            avatarMaterial: formData.avatarMaterial ? URL.createObjectURL(formData.avatarMaterial) : prev.avatarMaterial,
        }));
                    ...
                    <div className="card card-flush py-4">
                        ...
                        <div className="card-body text-center pt-0">
                            ...
                            <div className="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div className="image-input-wrapper w-150px h-150px" style={{ backgroundImage: `url(${imagePreviews.avatarMaterial})` }}></div>
                                ...
                                <label
                                    ...
                                    <input type="file" name="avatarMaterial" accept=".png, .jpg, .jpeg, .svg" onChange={handleFileChange} />
                            ...
                            <div className="text-muted fs-7">Set the material thumbnail image. Only *.png, *.jpg, *.svg
                                ...
                                <div className="card card-flush py-4">
                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <label className="required form-label">Material Name</label>



                                            <input type="text" name="material_name" className="form-control mb-2"
                                                placeholder="Material name" defaultValue={formData.material_name} onChange={handleInputChange} required/>



                                            <div className="text-muted fs-7">A material name is required and
                                        ...
                                        <div className='mb-2 fv-row'>
                                            ...
                                            <div className="mb-2">
                                                <textarea className="form-control" defaultValue={formData.materialdescription}  placeholder="Description" name="materialdescription" id="floatingTextarea2" style={{ height: "100px", borderRadius: "15px" }} onChange={handleInputChange} ></textarea>
                                            </div>
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <label htmlFor="kt_ecommerce_add_product_store_template"
                                                ...
                                                name="materialtype"
                                                value={options.find(option => option.value === formData.materialtype)}
                                            ...
                                            <div className="text-muted fs-7">Assign a material type from your material.</div>
                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className="mb-10 fv-row">
                                            ...
                                            <input type="text" name="price" className="form-control mb-2"
                                                placeholder="Product price" value={formData.price} onChange={handleInputChange} required/>
