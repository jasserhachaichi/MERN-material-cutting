                                    ...
                                    <div className="card-body pt-0">
                                        ...
                                        <div className="mb-2 fv-row">
                                            ...
                                            <input type="text" name="material_name" className="form-control mb-2"
                                                placeholder="Material name" defaultValue={formData.material_name} onChange={handleInputChange} />
                                        ...
                                        <div className='mb-2 fv-row'>
                                            ...
                                            <div className="mb-2">
                                                <textarea className="form-control" placeholder="Description" name="materialdescription" id="floatingTextarea2" style={{ height: "100px", borderRadius: "15px" }} onChange={handleInputChange} ></textarea>
                                            </div>
