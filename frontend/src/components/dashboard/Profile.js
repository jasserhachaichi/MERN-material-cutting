                    ...
                    <div className="card mb-5 mb-xl-8">
                        ...
                        <div className="card-body">
                            <div className="d-flex flex-center flex-column py-5">
                                ...
                                <a  className="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{user.firstName} {user.lastName !== "its$fromgoogle" ? user.lastName : ""}</a>
                            </div>
    ...
    <div className="card-header border-0">
        ...
        <div className="card-title flex-column">
            ...
            <div className="fs-6 fw-semibold text-muted">Choose what messages you d
                like to receive for each of your accounts.</div>
        </div>

    </div>

    <div className="card-body">
        <form id="kt_account_deactivate_form" className="form fv-plugins-bootstrap5 fv-plugins-framework" noValidate="novalidate">
            ...
            <div className="card-body border-top p-9">
                ...
                <div className="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ">
                        ...
                        <div className=" fw-semibold">
                            <h4 className="text-gray-900 fw-bold">You Are Deactivating Your Account
                            </h4>

                            <div className="fs-6 text-gray-700 ">For extra security, this requires
                                you to confirm your email or phone number when you reset
                                yousignr password. <br /><a className="fw-bold" href="#">Learn
                                    more</a></div>
                        </div>
                ...
                <div className="form-check form-check-solid fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                    <input name="deactivate" className="form-check-input" type="checkbox" value="" id="deactivate"  onChange={handleCheckboxChange} />
                    <label className="form-check-label fw-semibold ps-2 fs-6" for="deactivate">I
                        confirm my account deactivation</label>
                    <div className="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"><div data-field="deactivate" data-validator="notEmpty">Please check the box to deactivate your account</div></div></div>

            </div>

            <div className="card-footer d-flex justify-content-end py-6 px-9">
                <button id="kt_account_deactivate_account_submit" type="button" className="btn btn-danger fw-semibold" disabled={!isChecked} onClick={handleDelete}>Deactivate Account</button>
            </div>
