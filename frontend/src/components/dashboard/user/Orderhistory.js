        ...
        () => [
          {
            Header: 'See',
            Cell: ({ row }) => (
              <a href={`/user/orderView/${row.original._id}`} className="btn btn-link btn-color-dark btn-active-color-primary me-5 mb-2">
            ...
            Cell: ({ row }) => (
              <div className="text-end">
                {row.original.status === 'pending' ? (
                  <>
                    <button className="btn btn-link btn-color-warning btn-active-color-primary me-5 mb-2" onClick={() => handleCancel(row.original._id)}>
                    Cancel
                    </button>
                    <button className="btn btn-link btn-color-danger btn-active-color-primary me-5 mb-2" onClick={() => handleDelete(row.original._id)}>
                    DELETE
                    </button>
                    <a href={`/user/editorder/${row.original._id}/`}  className="btn btn-icon btn-info rounded-0 me-2"><i class="ki-duotone ki-pencil fs-1"> <span class="path1"></span> <span class="path2"></span> </i></a>
                  </>
                ): 'No Action'   
    ...
    return (
        ...
        <div className="card-header border-0 pt-6">
            ...
            <div className="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <a href="/user/addorder" className="btn btn-primary">Create Order</a>
