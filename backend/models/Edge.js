...
EdgeSchema.methods.validateInputs = function() {
  ...
  for (const key in this._doc) {
    if (this[key] === 0 || this[key] === '0' || this[key] === "") {
      delete this[key];
    }
  }
  ...
  if (
    ...
    (!this.discounted_percentage || this.discounted_percentage === 0 || this.discounted_percentage < 0 || this.discounted_percentage === '0')
  ) {
  ...
  if (
    ...
    (!this.discounted_price || this.discounted_price === 0|| this.discounted_price < 0 || this.discounted_price === '0')
  ) {
    this.discount_option = 1;
  }
};
