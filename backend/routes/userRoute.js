...
const {getclients,deleteclient,updatecountry,updatetown,updatepostcode,updatestate,updatephone, updateaddress1,updateaddress2, allclients,allstaffs,addstaff, deletestaff, getuser,updateEmail,updatePassword, updateRole,updateDetails, updateFname, updateLname} = require("../controllers/UserController.js");
...
router.delete("/deleteaccount/:id",deleteclient);
